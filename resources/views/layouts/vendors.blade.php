                        ...
                        <div class="header-menu">
                            ...
                            <div class="nav-animation header-nav navbar-collapse collapse d-flex justify-content-start">
                                ...
                                <ul class=" nav navbar-nav">
                                    ...
                                    <li>
                                        <a href="{{ route('vendors_profile') }}">
                                            <span class="admin-nav-text">Profile</span></a>
                                    </li>
        ...
        <nav id="sidebar-admin-wraper">
            ...
            <div class="admin-nav">
                <ul class="">
                    ...
                    <li>
                        <a href="{{ route('vendors_profile') }}"><i
                                class="fa fa-user-circle-o"></i><span class="admin-nav-text">Profile</span></a>
                    </li>

                    <li>
                        <a href="{{ route('my.booking') }}"><i class="fa fa-calendar"></i><span
                                class="admin-nav-text">My Booking</span></a>
                    </li>
